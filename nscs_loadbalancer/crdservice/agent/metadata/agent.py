...
from nscs_loadbalancer.crdservice.agent.common import config as agent_conf
from nscs_loadbalancer.crdservice.agent import rpc as agent_rpc
from nscs.crdservice.common import config
from nscs.crdservice.common import constants as n_const
...
class MetadataProxyHandler(object):
    ...
    def _get_instance_and_tenant_id(self, req):
        ...
        network_id = req.headers.get('X-Crd-Network-ID')
        router_id = req.headers.get('X-Crd-Router-ID')
