...
from nscs_loadbalancer.crdservice.agent.common import config
from nscs_loadbalancer.crdservice.agent.linux import external_process
from nscs_loadbalancer.crdservice.agent.linux import interface
from nscs_loadbalancer.crdservice.agent.linux import ip_lib
from nscs_loadbalancer.crdservice.agent.linux import iptables_manager
from nscs_loadbalancer.crdservice.agent.linux import ovs_lib  # noqa
from nscs_loadbalancer.crdservice.agent import rpc as agent_rpc
from nscs.crdservice.common import constants as l3_constants
from nscs.crdservice.common import legacy
from nscs_loadbalancer.crdservice import topics
from nscs.crdservice.common import utils as common_utils
...
from nscs.crdservice.openstack.common import loopingcall
from nscs.crdservice.openstack.common import periodic_task
from nscs.crdservice.openstack.common import processutils
from nscs.crdservice.openstack.common.rpc import common as rpc_common
from nscs.crdservice.openstack.common.rpc import proxy
from nscs.crdservice.openstack.common import service
from nscs.crdservice import service as neutron_service
from nscs.crdservice.services.firewall.agents.l3reference import firewall_l3_agent
...
class L3NATAgent(firewall_l3_agent.FWaaSL3AgentRpcCallback, manager.Manager):
    ...
    OPTS = [
        ...
        cfg.IntOpt('metadata_port',
                   default=9697,
                   help=_("TCP Port used by Crd metadata namespace "
                          "proxy.")),
