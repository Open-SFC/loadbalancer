...
from nscs_loadbalancer.crdservice.plugins.common import constants as qconstants
from nscs_loadbalancer.crdservice import constants
...
def generate_config(logical_config, socket_path=None,
                user_group='nogroup'):
