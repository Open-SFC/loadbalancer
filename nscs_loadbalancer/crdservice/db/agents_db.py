...
from nscs_loadbalancer.crdservice.extensions import agent as ext_agent
from nscs.crdservice import manager
from nscs.crdservice.openstack.common.db import exception as db_exc
...
class Agent(model_base.BASEV2, HasId):
...
class AgentExtRpcCallback(object):
    ...
    def report_state(self, context, **kwargs):
        ...
        if not self.plugin:
            self.plugin = manager.CrdManager.get_plugin()
